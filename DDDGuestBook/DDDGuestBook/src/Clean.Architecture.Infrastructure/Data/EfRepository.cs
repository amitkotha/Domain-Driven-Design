...
namespace Clean.Architecture.Infrastructure.Data
{
    public class EfRepository : IRepository
    {
        ...
        public Task<T> GetByIdAsync<T>(int id, string include) where T : BaseEntity, IAggregateRoot
        {
            return _dbContext.Set<T>().Include(include).SingleOrDefaultAsync(e => e.Id == id);
        }
    }
}
